...
import { W3cPresentationRequest } from "../vc/models/presentation/W3cPresentationRequest";
/**
...
export declare class DifPresentationExchangeService {
    ...
    createPresentationRequest(agentContext: AgentContext, presentationDefinition: DifPresentationExchangeDefinition, options: any, signPresentationRequest: boolean, signACPContext: boolean, context: string[], type: string[]): Promise<W3cPresentationRequest>;
    ...
    private getPresentationRequestSign;
    private getACPContextSign;
