...
class BaseCredentialProtocol {
    ...
    async processProblemReport(messageContext) {
        ...
        if (!(credentialRecord === null || credentialRecord === void 0 ? void 0 : credentialRecord.connectionId)) {
            await connectionService.matchIncomingMessageToRequestMessageInOutOfBandExchange(messageContext, {
                expectedConnectionId: credentialRecord === null || credentialRecord === void 0 ? void 0 : credentialRecord.connectionId,
            });
