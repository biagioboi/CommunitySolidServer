...
export declare class ConnectionService {
    ...
    private logger;
    constructor(logger: Logger, connectionRepository: ConnectionRepository, didRepository: DidRepository, eventEmitter: EventEmitter);
    /**
     ...
     */
    assertConnectionOrOutOfBandExchange(messageContext: InboundMessageContext, { lastSentMessage, lastReceivedMessage, expectedConnectionId, }?: {
     ...
     *
     */
    matchIncomingMessageToRequestMessageInOutOfBandExchange(messageContext: InboundMessageContext, { expectedConnectionId }: {
        expectedConnectionId?: string;
    }): Promise<void>;
