...
class DidExchangeRequestHandler {
    ...
    async handle(messageContext) {
        ...
        if (!recipientKey || !senderKey) {
            throw new CredoError_1.CredoError('Unable to process connection request without senderKey or recipientKey');
        }
        const parentThreadId = (_a = message.thread) === null || _a === void 0 ? void 0 : _a.parentThreadId;
        if (!parentThreadId) {
            throw new CredoError_1.CredoError(`Message does not contain 'pthid' attribute`);
        }
        ...
        if (!outOfBandRecord) {
            throw new CredoError_1.CredoError(`OutOfBand record for message ID ${parentThreadId} not found!`);
        }
        ...
        if (outOfBandRecord.state === OutOfBandState_1.OutOfBandState.Done) {
            throw new CredoError_1.CredoError('Out-of-band record has been already processed and it does not accept any new requests');
        }
