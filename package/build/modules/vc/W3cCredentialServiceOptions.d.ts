...
import { W3cPresentationRequest, W3cPresentationWrapper, W3cVerifiablePresentation } from "./models";
...
import { W3cWrappedVerifiablePresentation } from "./data-integrity";
...
export interface W3cCreatePresentationWrapperOptions {
    vp: W3cVerifiablePresentation;
    id?: string;
    holder?: string;
}
export interface W3cCreatePresentationRequestWrapperOptions {
    vpr: W3cPresentationRequest;
    termsAndCondition: AcpPolicy;
    id: string;
}
export interface W3cSignWrappedPresentationOptions {
    /**
     * The format of the presentation to be signed.
     *
     * @see https://identity.foundation/claim-format-registry
     ...
     * The presentation to be signed.
     */
    presentation: W3cPresentationWrapper;
    /**
     * URI of the verificationMethod to be used for signing the presentation.
     *
     * Must be a valid did url pointing to a key.
...
export interface W3cSignWrappedPresentationRequestOptions {
    /**
     * The format of the presentation to be signed.
     *
     * @see https://identity.foundation/claim-format-registry
    ...
    format: ClaimFormat.LdpVp;
    /**
     * The verifiable presentation request to be signed.
     */
    wrappedVPR: W3cPresentationRequestWrapper;
    termsAndCondition: AcpPolicy;
    /**
     * URI of the verificationMethod to be used for signing the presentation.
     *
...
export interface W3cVerifyWrappedPresentationOptions {
    /**
     * The presentation to be verified.
     */
    wrappedPresentation: W3cWrappedVerifiablePresentation;
    /**
     * The challenge / nonce that must present in the presentation prevent replay attacks.
     */
    challenge: string;
