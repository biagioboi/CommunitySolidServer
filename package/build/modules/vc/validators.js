...
exports.IsVerifiablePresentationRequestJsonLdContext = exports.IsCredentialJsonLdContext = void 0;
...
function IsVerifiablePresentationRequestJsonLdContext(validationOptions) {
    return (0, class_validator_1.ValidateBy)({
        ...
        validator: {
            validate: (value) => {
                if (!Array.isArray(value))
                    return false;
                // First item must be the verifiable credential context
                if (value[0] !== constants_1.VERIFIABLE_PRESENTATION_REQUEST_URL)
                    return false;
                return value.every((v) => ((0, class_validator_1.isString)(v) && (0, class_validator_1.isURL)(v)) || (0, utils_1.isJsonObject)(v));
            },
            defaultMessage: (0, class_validator_1.buildMessage)((eachPrefix) => eachPrefix +
                '$property must be an array of strings or objects, where the first item is the verifiable presentation request context URL.', validationOptions),
        },
    }, validationOptions);
}
exports.IsVerifiablePresentationRequestJsonLdContext = IsVerifiablePresentationRequestJsonLdContext;
