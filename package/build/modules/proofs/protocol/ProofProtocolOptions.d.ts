...
import type { ExtractProofFormats, ProofFormat, ProofFormatCredentialForRequestPayload, ProofFormatPayload, ProofFormatService } from '../formats';
 ...
 * ```
 */
export type ProofFormatDataMessagePayload<CFs extends ProofFormat[] = ProofFormat[], M extends keyof ProofFormat['formatData'] = keyof ProofFormat['formatData']> = {
 ...
 * ```
 */
export type ProofFormatsFromProtocols<Type extends ProofProtocol[]> = Type[number] extends ProofProtocol<infer ProofFormatServices> ? ProofFormatServices extends ProofFormatService[] ? ExtractProofFormats<ProofFormatServices> : never : never;
...
export interface SelectCredentialsForRequestReturn<PFs extends ProofFormatService[]> {
    proofFormats: ProofFormatCredentialForRequestPayload<ExtractProofFormats<PFs>, 'selectCredentialsForRequest', 'output'>;
}
