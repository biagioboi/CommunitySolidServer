...
class BaseProofProtocol {
    async processProblemReport(messageContext) {
        ...
        if (!(proofRecord === null || proofRecord === void 0 ? void 0 : proofRecord.connectionId)) {
            await connectionService.matchIncomingMessageToRequestMessageInOutOfBandExchange(messageContext, {
                expectedConnectionId: proofRecord === null || proofRecord === void 0 ? void 0 : proofRecord.connectionId,
            });
