...
export declare class V2ProofProtocol<PFs extends ProofFormatService[] = ProofFormatService[]> extends BaseProofProtocol implements ProofProtocol<PFs> {
     ...
     *
     */
    createWrappedRequest(agentContext: AgentContext, { proofFormats, autoAcceptProof, comment, connectionRecord, parentThreadId, goalCode, goal, willConfirm, requestWrapper }: CreateProofRequestOptions<PFs>): Promise<ProofProtocolMsgReturnType<V2RequestPresentationMessage>>;
    /**
