...
import { FormatCreateWrappedRequestOptions } from "../ProofFormatServiceOptions";
export declare class DifPresentationExchangeProofFormatService implements ProofFormatService<DifPresentationExchangeProofFormat> {
    ...
    createWrappedRequest(agentContext: AgentContext, { attachmentId, proofFormats, requestWrapper }: FormatCreateWrappedRequestOptions<DifPresentationExchangeProofFormat>): Promise<ProofFormatCreateReturn>;
}
