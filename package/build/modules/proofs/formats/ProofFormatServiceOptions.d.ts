...
export interface FormatCreateWrappedRequestOptions<PF extends ProofFormat> {
    proofRecord: ProofExchangeRecord;
...
export type ProofFormatGetCredentialsForRequestReturn<PF extends ProofFormat> = PF['proofFormats']['getCredentialsForRequest']['output'];
...
export type ProofFormatSelectCredentialsForRequestReturn<PF extends ProofFormat> = PF['proofFormats']['selectCredentialsForRequest']['output'];
