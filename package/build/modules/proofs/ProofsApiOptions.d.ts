...
import type { DeleteProofOptions, GetProofFormatDataReturn, ProofFormatsFromProtocols } from './protocol/ProofProtocolOptions';
import { W3cPresentationRequestWrapper } from "../vc/models/presentation/W3cPresentationRequestWrapper";
...
export type FindProofPresentationMessageReturn<PPs extends ProofProtocol[]> = ReturnType<PPs[number]['findPresentationMessage']>;
/**
...
export interface CreateProofRequestOptions<PPs extends ProofProtocol[] = ProofProtocol[]> extends BaseOptions {
    ...
    /** @default true */
    willConfirm?: boolean;
    requestWrapper?: W3cPresentationRequestWrapper;
}
/**
 * Interface for ProofsApi.requestCredential. Extends CreateProofRequestOptions, will send a request
 */
export interface RequestProofOptions<PPs extends ProofProtocol[] = ProofProtocol[]> extends BaseOptions, CreateProofRequestOptions<PPs> {
    connectionId: string;
}
/**
...
export interface GetCredentialsForProofRequestOptions<PPs extends ProofProtocol[] = ProofProtocol[]> {
    proofRecordId: string;
    proofFormats?: ProofFormatCredentialForRequestPayload<ProofFormatsFromProtocols<PPs>, 'getCredentialsForRequest', 'input'>;
}
export interface GetCredentialsForProofRequestReturn<PPs extends ProofProtocol[] = ProofProtocol[]> {
    proofFormats: ProofFormatCredentialForRequestPayload<ProofFormatsFromProtocols<PPs>, 'getCredentialsForRequest', 'output'>;
}
/**
...
export interface SelectCredentialsForProofRequestReturn<PPs extends ProofProtocol[] = ProofProtocol[]> {
    proofFormats: ProofFormatCredentialForRequestPayload<ProofFormatsFromProtocols<PPs>, 'selectCredentialsForRequest', 'output'>;
}
/**
